        ...
        if(slackUser) {
          ...
          if(fileUser.manager && !slackUser.manager) {
            ...
            if(fileVsSlackDifference.slackManager) {
              fileVsSlackDifference.fixAction = FixAction.SetSlackManager;
            }
            else {
...
function FileVsSlackDifferencesList(props: FileVsSlackDifferencesListProps) {
  ...
  async function onFixInSlackButtonClick(difference: FileVsSlackDifference) {
    ...
    case FixAction.SetSlackManager:
      await setSlackManager(difference, fileVsSlackDifferences, instance, silentRequest, props.setFileVsSlackDifferences);
      break;
...
async function setSlackManager(difference: FileVsSlackDifference,
